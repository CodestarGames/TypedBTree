...
export class Console {
	...
	private log_element: Element;
	private input: HTMLInputElement;
	private _prompt: ((content, callback, options) => Dialog) | string;
	private onAutocomplete: null;
	private onProcessCommand: null;
	history: any[];
	private _history_offset: number;
	private _input_blocked: any;
	constructor(options ) {
		options = options || {};
