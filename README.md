# ![logo](https://github.com/nikkorn/typedBTree/raw/master/icons/icon-small.png) TypedBTree
[![npm version](https://badge.fury.io/js/typedBTree.svg)](https://badge.fury.io/js/typedBTree)
...
There is an in-browser editor and tree visualiser that you can try [HERE](https://nikkorn.github.io/typedBTree/playground/index.html)
...
const board = {
    ...
    Attack: () => {
        ...
        if (!this.isHoldingWeapon()) {
            ...
            return TypedBTree.State.FAILED;
        }
